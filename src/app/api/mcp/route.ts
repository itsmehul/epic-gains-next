...
const mcpHandler = createMcpHandler(
  ...
  },
  {
    ...
    instructions: [
      ...
      "When importing a follow-along video, match /workouts/import: call get_youtube_import_prompt, apply that prompt to the video, then pass the extracted JSON (overview + sections + MM:SS timestamps) to import_full_workout with sourceVideoUrl. Do not convert clocks to seconds or invent videoEndTime. Do not assemble the session with other workout tools.",
