...
CREATE INDEX "mcp_api_key_user_id_idx" ON "mcp_api_key" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "mcp_api_key_key_hash_idx" ON "mcp_api_key" USING btree ("key_hash");--> statement-breakpoint
...
CREATE INDEX "workout_userId_idx" ON "workout" USING btree ("user_id");
